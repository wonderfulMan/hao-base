export const ENTRY_FILE_STAT = ['index.js', 'index.ts', 'index.tsx', 'index.jsx']
export const HTML_PLUGIN_TPL = ['index.html']
export const OUT_PUT_PATH = 'dist'
