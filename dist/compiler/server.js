...
function server(webpackConfig, customConfig) {
    ...
    var devServerConfig = __assign({ host: host, port: 8080, open: true, historyApiFallback: true, overlay: true, compress: true, hotOnly: true, hot: webpackConfig.mode === 'development', quiet: true, contentBase: path_1.default.BUIL_DIR_PATH }, customConfig.devServer);
