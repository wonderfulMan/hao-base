...
function addModeToConfig(config) {
...
exports.addModeToConfig = addModeToConfig;
...
function addPluginsToConfig(webpackConfig, customConfig, shellArgs) {
    var plugins = [];
    var definePlugins = plugin_1.setGlobalVarsToContext(webpackConfig, customConfig, shellArgs);
    var cleanPlugin = plugin_1.setCleanDirByBuild(webpackConfig, customConfig, shellArgs);
